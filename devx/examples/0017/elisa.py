...
ofile = open('elisa_rayleigh.dat','w')
ofile.write('$ENTER COMPONENT NAME = DFLT_COMP\n')
ofile.write('    $SYSTEM NAME = S_STEP_2\n')
#ofile.write('        $INSERT VARIANT\n')
#ofile.write('            S_STEP_1\n')

xi = 0.01 # modal damping ratio
