...
Plane Surface(5) = {5};
//+
Transfinite Curve {1, 3, 9, 12} = 7 Using Progression 1;
//+
Transfinite Curve {4, 2, 6, 11, 13, 15} = 7 Using Progression 1;
//+
Transfinite Curve {10, 8} = 13 Using Progression 1;
//+
Transfinite Curve {5, 7, 14, 16} = 75 Using Progression 1;
//+
...
//+//+
Extrude {0, 0, 1.5} {
  Surface{2}; Surface{1}; Surface{3}; Surface{5}; Surface{4}; Layers {3}; Recombine;
}
//+
Physical Volume("BEAM", 127) = {1, 2, 4, 3, 5};
