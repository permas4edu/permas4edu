...
ax1.plot(2*np.pi*df['Frequency'],df['H1-N101,u'],c='r',label=r'$H_1@x_1$')
ax2.plot(2*np.pi*df['Frequency'],df['H1-N102,u'],c='g',label=r'$H_1@x_2$')
ax1.grid()
ax2.grid()
...
ax2.set_xticks(np.linspace(0.8,1.3,6))
