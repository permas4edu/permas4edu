...
|----    | ----    | ---- |  ---- |
| bokeh | 2.4.2 | 3.5.2 | 3.10.0 |
| conda | | 24.7.1 |  26.7.1 |
| contourpy |  | 1.2.1 | 1.3.3   |
| cython | N/A | 3.0.11 | 3.2.9  |
...
| narwhals | N/A | N/A | 2.25.0 |
| numexpr | | 2.10.0 |  2.14.2 |
| numpy  | 1.22.3  | 1.26.4 | 2.5.2   |
| numpy-stl | 2.17.1 | 3.1.2 | 4.0.0   |
| OCC | 7.4.1-dev | 7.8.1  |  7.9.0   |
| openpyxl | 3.0.9 | 3.1.5 |  3.1.5   |
| pandas | 1.4.2   | 2.2.2 |  3.0.5   |
| PIL    | 9.0.1   | 10.4.0 |  12.3.0  |
| pip    |     | 24.2 |   26.1.2   |
| plotly | 5.6.0 |  5.23.0 | 6.9.0    |
| psutil | | 6.0.0 |  7.2.2    |
